...
describe 'Boxes View' do
  ...
  context 'Form' do
    it 'should save box if form is filled with valid data' do
      find("div.#{@entities} div.title").find('a.add').click
    ...
    it 'should not save box if form is filled with incorrect values' do
    ...
    it 'should not save box with existing name' do
      find("div.#{@entities} div.title").find('a.add').click
      find("div.#{@entities} div.title").find('a.save').click
      sleep(3)
      find("div.#{@entities} div.title").find('a.add').click
